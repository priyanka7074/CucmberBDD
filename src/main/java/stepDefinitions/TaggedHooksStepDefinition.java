package stepDefinitions;
	...
	public class TaggedHooksStepDefinition {
		...
		public void setUP1(){
			...
			System.out.println("Enter URL for Free CRM APP for Setup1");
		}

		@After(order=1)
		public void tearDown1(){
			System.out.println("close the browser for tearDown1 ");
		} 
		
		//local -- only for 1st scenario
		@Before("@First")
